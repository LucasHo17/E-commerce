    ...
    try {
        ...
        if (product.image) {
            ...
            try {
                ...
                console.log("delete image fron cloudinary")
            } catch (error) {
...
export const getProductsByCategory = async (req, res) => {
    ...
    try {
        ...
        console.log("Error in getProductsByCategory controller", error.mesage);
...
export const toggleFeaturedProduct = async(req, res) => {
    try {
        ...
        console.log("Error in toggleFeaturedProduct controller", error.mesage);
        res.status(500).json({message: "Server error", error: error.message});
    }
};
